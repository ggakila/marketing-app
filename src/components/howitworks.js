  ...
  return (
    <div className="container h-1/2 md:h-screen py-5 md:py-10 px-10 flex flex-col items-center justify-center gap-10">
      ...
      <div className="w-1/3 flex flex-col  gap-8 items-center justify-center p-6">
        ...
        <p className="text-md md:text-lg text-center text-gray-600 font-medium">Simply input your business detailes, industry and customer demographics.</p>
      </div>
      <div className="w-1/3 flex flex-col  gap-8 items-center justify-center p-6 ">
        <div className="relative w-12 h-12">
            <Image
        ...
        <p className="text-md md:text-lg text-center text-gray-600 font-medium">Our AI analyzes your customer demographics to understand their preferences and behavior</p>
      </div>
      <div className="w-1/3 flex flex-col  gap-8 items-center justify-center p-6">
        <div className="relative w-12 h-12">
            <Image
        ...
        <p className="text-md md:text-lg text-center text-gray-600 font-medium">Based on your business details, industry and customer demogrphocs, our AI generates personalized marketing campaigns tailored to your target audience.</p>
      </div>
      </div>
