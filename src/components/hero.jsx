...
export default function Hero() {
  return (
    <div className="container flex flex-col items-center justify-center h-screen w-full py-10 gap-20 mt-20">
        <div className=" flex flex-col items-center justify-center w-4/5 gap-4">
            <h1 className="text-6xl font-bold w-full sm:w-1/2 text-center leading-normal tracking-normal lead">Unlock your Business's Potential with AI</h1>
        ...
        <div className="hero-image relative w-4/5 h-2/3">
            <Image
